...
<part name="D2" library="diode" deviceset="DIODE-" device="SOD323-R" value="Z5V1"/>
<part name="D1" library="diode" deviceset="DIODE-" device="SOD323-R" value="Z5V1"/>
...
<text x="7.62" y="134.62" size="1.778" layer="91">Agnadir:
- Buzzer (SG1, con transistor y resistencia de 330R, ver circuito OpenLRS)
- PPM Input control circuit
- Telemetry output pins (5: PPM, 4: RX (TX selectable), 3: VCC, 2: GND, 1: RX (RX selectable))
- Trainer port (2 pin header y conector mono vertical externo, poner diodos 1N4148 de proteccion))
- Conector I2C externo
- Conector PPM in (a parte del del modulo), con conector mono vertical externo
</text>
</plain>
<instances>
...
<instance part="GND28" gate="1" x="-78.74" y="-63.5" rot="MR0"/>
<instance part="C5" gate="G$1" x="-78.74" y="-48.26"/>
...
<instance part="GND14" gate="1" x="-15.24" y="-68.58" rot="MR0"/>
<instance part="GND15" gate="1" x="-15.24" y="-25.4" rot="MR180"/>
...
<instance part="D2" gate="G$1" x="-15.24" y="-33.02" rot="R270"/>
<instance part="D1" gate="G$1" x="-15.24" y="-60.96" rot="R90"/>
