...
/* Get Link Status (Control Reception) */
#define RF_GET_CONTROL_LINK_STATUS RFHandler_GetLinkStatus()
...
/* Get SafeLink Status (Control Reception) */
#define SL_GET_CONTROL_LINK_STATUS SafeLinkHandler_GetLinkStatus()
